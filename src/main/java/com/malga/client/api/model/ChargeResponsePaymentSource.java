...
public class ChargeResponsePaymentSource extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(ChargeResponsePaymentSource.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!ChargeResponsePaymentSource.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'ChargeResponsePaymentSource' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<ChargeResponsePaymentSource>() {
                @Override
                public void write(JsonWriter out, ChargeResponsePaymentSource value) throws IOException {
                    ...
                    throw new IOException("Failed to serialize as the type doesn't match oneOf schemas: SourceTypeCard, SourceTypeCardOneShot, SourceTypeCustomer, SourceTypeToken");
                }

                @Override
                public ChargeResponsePaymentSource read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        ChargeResponsePaymentSource ret = new ChargeResponsePaymentSource();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonObject));
                        return ret;
                    }

                    throw new IOException(String.format("Failed deserialization for ChargeResponsePaymentSource: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public ChargeResponsePaymentSource() {
        super("oneOf", Boolean.FALSE);
    }

    public ChargeResponsePaymentSource(SourceTypeCard o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ChargeResponsePaymentSource(SourceTypeCardOneShot o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ChargeResponsePaymentSource(SourceTypeCustomer o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public ChargeResponsePaymentSource(SourceTypeToken o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return ChargeResponsePaymentSource.schemas;
    }

    /**
     * Set the instance that matches the oneOf child schema, check
     * the instance parameter is valid against the oneOf child schemas:
     * SourceTypeCard, SourceTypeCardOneShot, SourceTypeCustomer, SourceTypeToken
     *
    ...
    public void setActualInstance(Object instance) {
        ...
        throw new RuntimeException("Invalid instance type. Must be SourceTypeCard, SourceTypeCardOneShot, SourceTypeCustomer, SourceTypeToken");
    }
     ...
     * SourceTypeCard, SourceTypeCardOneShot, SourceTypeCustomer, SourceTypeToken
     *
     * @return The actual instance (SourceTypeCard, SourceTypeCardOneShot, SourceTypeCustomer, SourceTypeToken)
     */
    @Override
  ...
  * @throws IOException if the JSON Object is invalid with respect to ChargeResponsePaymentSource
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount != 1) {
      throw new IOException(String.format("The JSON string is invalid for ChargeResponsePaymentSource with oneOf schemas: SourceTypeCard, SourceTypeCardOneShot, SourceTypeCustomer, SourceTypeToken. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonObj.toString()));
    }
  }

 /**
  * Create an instance of ChargeResponsePaymentSource given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ChargeResponsePaymentSource
  * @throws IOException if the JSON string is invalid with respect to ChargeResponsePaymentSource
  */
  public static ChargeResponsePaymentSource fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ChargeResponsePaymentSource.class);
  }

 /**
  * Convert an instance of ChargeResponsePaymentSource to an JSON string
  *
  * @return JSON string
  */
