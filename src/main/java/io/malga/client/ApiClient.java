...
public class ApiClient {
    ...
    private void init() {
        ...
        setUserAgent("malga-api-sdk/0.1/java");
    ...
    public <T> T deserialize(Response response, Type returnType, Gson gson) throws ApiException {
     ...
     * @throws ApiException If fail to execute the call
     */
    public <T> ApiResponse<T> execute(Call call, Type returnType, Gson gson) throws ApiException {
        try {
            Response response = call.execute();
            T data = handleResponse(response, returnType, gson);
    ...
    public <T> void executeAsync(Call call, ApiCallback<T> callback) {
        executeAsync(call, null, callback, null);
    }
    ...
    public <T> void executeAsync(Call call, final Type returnType, final ApiCallback<T> callback, Gson gson) {
        call.enqueue(new Callback() {
            ...
            public void onResponse(Call call, Response response) throws IOException {
                T result;
                try {
                    result = (T) handleResponse(response, returnType, gson);
     ...
     */
    public <T> T handleResponse(Response response, Type returnType, Gson gson) throws ApiException {
        if (response.isSuccessful()) {
            if (returnType == null || response.code() == 204) {
                ...
                return deserialize(response, returnType, gson);
            }
        } else {
