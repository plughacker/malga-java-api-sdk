...
public class CustomerList {
  ...
  public CustomerList meta(MetaPagination meta) {
  ...
  **/
   ...
   * @return the CustomerList instance itself
   */
  public CustomerList putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.meta, customerList.meta) &&
        Objects.equals(this.items, customerList.items)&&
        Objects.equals(this.additionalProperties, customerList.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to CustomerList
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CustomerList.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<CustomerList>() {
           ...
           public CustomerList read(JsonReader in) throws IOException {
             ...
             CustomerList instance = thisAdapter.fromJsonTree(jsonObj);
