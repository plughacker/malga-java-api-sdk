...
import io.malga.model.clienttoken.JSON;

/**
 * ErrorResponseError
 */
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2023-06-28T18:26:36.644160-03:00[America/Sao_Paulo]")
public class ErrorResponseError {
  ...
  **/
  ...
  public ErrorResponseError declinedCode(String declinedCode) {
  ...
  **/
  ...
  public ErrorResponseError details(List details) {
  ...
  * @throws IOException if the JSON Object is invalid with respect to ErrorResponseError
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ErrorResponseError.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
