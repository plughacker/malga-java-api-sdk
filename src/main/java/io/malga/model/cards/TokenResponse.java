...
public class TokenResponse {
  ...
  **/
   ...
   * @return the TokenResponse instance itself
   */
  public TokenResponse putAdditionalProperty(String key, Object value) {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<TokenResponse>() {
           ...
           public TokenResponse read(JsonReader in) throws IOException {
             ...
             TokenResponse instance = thisAdapter.fromJsonTree(jsonObj);
