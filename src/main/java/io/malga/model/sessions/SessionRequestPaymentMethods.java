...
import io.malga.model.sessions.PaymentMethodBoleto;
import io.malga.model.sessions.PaymentMethodBoletoFine;
import io.malga.model.sessions.PaymentMethodBoletoInterest;
import io.malga.model.sessions.PaymentMethodCard;
import io.malga.model.sessions.PaymentMethodPix;
...
public class SessionRequestPaymentMethods extends AbstractOpenApiSchema {
    ...
    public SessionRequestPaymentMethods(PaymentMethodBoleto o) {
        super("anyOf", Boolean.FALSE);
        setActualInstance(o);
    }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount == 0) {
      throw new IOException(String.format("The JSON string is invalid for SessionRequestPaymentMethods with anyOf schemas: PaymentMethodBoleto, PaymentMethodCard, PaymentMethodPix. JSON: %s", jsonObj.toString()));
    }
  }
