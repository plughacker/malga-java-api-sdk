...
public class SourceTypeCard {
  ...
  **/
  ...
  public SourceTypeCard cardId(String cardId) {
  ...
  **/
   ...
   * @return the SourceTypeCard instance itself
   */
  public SourceTypeCard putAdditionalProperty(String key, Object value) {
  ...
  * @throws IOException if the JSON Object is invalid with respect to SourceTypeCard
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!SourceTypeCard.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SourceTypeCard.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SourceTypeCard' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SourceTypeCard> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SourceTypeCard.class));

       return (TypeAdapter<T>) new TypeAdapter<SourceTypeCard>() {
           @Override
           public void write(JsonWriter out, SourceTypeCard value) throws IOException {
           ...
           @Override
           public SourceTypeCard read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             SourceTypeCard instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of SourceTypeCard given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of SourceTypeCard
  * @throws IOException if the JSON string is invalid with respect to SourceTypeCard
  */
  public static SourceTypeCard fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SourceTypeCard.class);
  }
...
/** * Convert an instance of SourceTypeCard to an JSON string
  *
  * @return JSON string
  */
